...
public class LunarPanelBlock extends Block {
    public LunarPanelBlock(net.minecraft.world.level.block.state.BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    public static final VoxelShape UpShape = Stream.of(
            ...
            net.minecraft.world.level.block.Block.box(0.75, 12.75, 6, 15.25, 14.75, 10),
            ...
            net.minecraft.world.level.block.Block.box(11, 12, 7, 13, 13, 9),
            Block.box(11.25, 11, 7.25, 11.75, 12, 7.75),
            Block.box(12.25, 6, 8.25, 12.75, 12, 8.75),
            Block.box(12, 6, 8, 13, 6.25, 9),
            net.minecraft.world.level.block.Block.box(9.25, 10.5, 7.25, 11.75, 11, 7.75),
