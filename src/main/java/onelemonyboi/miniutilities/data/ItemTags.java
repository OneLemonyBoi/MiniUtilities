...
public class ItemTags extends ItemTagsProvider {
    public ItemTags(DataGenerator dataGenerator, BlockTagsProvider blockTagProvider, ExistingFileHelper existingFileHelper, CompletableFuture<HolderLookup.Provider> future) {
        super(dataGenerator.getPackOutput(), future, blockTagProvider.contentsGetter(), MiniUtilities.MOD_ID, existingFileHelper);
    }
