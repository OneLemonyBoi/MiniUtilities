...
public class BlockList {
    ...
    public static final RegistryObject<Block> SolarPanel = register("solar_panel", () -> new SolarPanelBlock(Properties.copy(Blocks.IRON_BLOCK)));
    public static final RegistryObject<Block> LunarPanel = register("lunar_panel", () -> new LunarPanelBlock(Properties.copy(net.minecraft.world.level.block.Blocks.IRON_BLOCK)));
    ...
    private static <T extends Block> net.minecraftforge.registries.RegistryObject<T> registerNoItem(String name, Supplier<T> block) {
        return ModRegistry.BLOCKS.register(name, block);
    }

    private static <T extends Block> net.minecraftforge.registries.RegistryObject<T> registerNoTab(String name, Supplier<T> block) {
        net.minecraftforge.registries.RegistryObject<T> ret = registerNoItem(name, block);
        ModRegistry.ITEMS.register(name, () -> new BlockItem(ret.get(), new net.minecraft.world.item.Item.Properties()));
        return ret;
    }
