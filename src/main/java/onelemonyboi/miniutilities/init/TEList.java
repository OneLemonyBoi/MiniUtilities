...
public class TEList {
    ...
    public static final RegistryObject<TileEntityType<MechanicalMinerTile>> MechanicalMinerTile = ModRegistry.TE.register("mechanical_miner", () -> TileEntityType.Builder.create(MechanicalMinerTile::new, BlockList.MechanicalMiner.get()).build(null));
