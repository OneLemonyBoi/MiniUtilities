...
public class TEList {
    ...
    public static final RegistryObject<TileEntityType<LaserPortTile>> LaserPortTile = ModRegistry.TE.register("laser_port", () -> TileEntityType.Builder.create(() -> new LaserPortTile(), BlockList.LaserPort.get()).build(null));
